...
import { registerExportFonts } from "@/lib/document-export/fonts";
import { DocumentPdf } from "@/lib/document-export/pdf-document";
...
export async function GET(
  ...
  return new NextResponse(new Uint8Array(buffer), {
    headers: {
      ...
      "Content-Disposition": `attachment; filename="${document.template.slug}.pdf"`,
    },
  });
}
